...
import { KeywordList } from "../components/common/KeywordList";
  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50 group">
        ...
        {/* Tooltip on hover */}
        <div className="absolute right-16 bottom-2 bg-gray-800 text-white text-sm px-3 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
          {labels.keywordList.lastExtracted}
        </div>
      </div>
      )}
